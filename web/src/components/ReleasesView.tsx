...
// the GitHub Releases API for malcolmston/pandas.
const RELEASE_LIBS: RelLib[] = [
  { name: PANDAS.name, icon: PANDAS.icon, accent: PANDAS.accent, repo: ghrepo(PANDAS), url: PANDAS.repo },
];
