...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/pandas', initials: 'pd', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/pandas</span> — pandas-style DataFrames and data analysis, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · independent re-implementation of pandas</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/pandas" footer={footer}>
